...
namespace _2FAQRCodeDemo
{
    public class ObservableObject : INotifyPropertyChanged
    {
        ...
        [NotifyPropertyChangedInvocator]
        protected virtual void UpdateOnPropertyChanged<T>(ref T variable, T value, [CallerMemberName] string propertyName = null) where T : IEquatable<T>
        {
        ...
        [NotifyPropertyChangedInvocator]
        protected virtual void UpdateEnumOnPropertyChanged<T>(ref T variable, T value, [CallerMemberName] string propertyName = null) where T : Enum
        {
